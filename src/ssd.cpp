...
KVCache::Status SSD::create(const std::string &db_path, SSD **ssd, const Config &ssd_config, const rocksdb::Options &rocksdb_options)
    {
        ...
        delete db;
        *ssd = new SSD(db_path, rocksdb_options);
        return Status::OK();
    }
